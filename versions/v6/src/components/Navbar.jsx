            ...
            <div className="relative" ref={productsDropdownRef}>
              ...
              <div className={`absolute left-0 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${productsDropdownOpen ? '' : 'hidden'}`}>
                <div className="py-1">
                  ...
                  <Link to="/components/videocard" className="block px-4 py-2 text-left text-gray-700 hover:bg-gray-300" onClick={handleDropdownItemClick}>Video Card</Link>
      ...
      <div className={`md:hidden ${mobileMenuOpen ? '' : 'hidden'}`} id="mobile-menu-container">
        <div className="space-y-1 px-2 pb-3 pt-2 z-auto">
          ...
          <div className={`space-y-1 pl-6 ${mobileProductsDropdownOpen ? '' : 'hidden'}`} id="mobile-products-dropdown-menu" ref={mobileProductsDropdownRef}>
            ...
            <a href="/components/videocard" className="block text-left  rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">GPU</a>
            ...
            <a href="/components/memory" className="block text-left rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">RAM</a>
