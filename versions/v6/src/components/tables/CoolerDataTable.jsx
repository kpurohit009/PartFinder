...
const CoolerDataTable = ({ coolerData, onSelectCooler }) => {
  return (
          ...
          <table className="w-full table-auto text-sm sm:text-base">
            <thead className="hidden bg-gray-200 text-gray-700 lg:table-header-group">
              <tr>
                ...
                {/* <th className="px-2 py-2 text-right font-medium sm:px-4 sm:py-3">Add</th> */}
              ...
              {coolerData.map((cooler, index) => (
                <tr key={index} className="block border-b lg:table-row">
                  ...
                  <td className="block px-2 py-2 text-right sm:px-4 sm:py-3 lg:table-cell">
                    ...
                    <a href={cooler.buyLink} className="rounded bg-blue-500 px-3 py-1 text-xs font-medium text-white hover:bg-blue-600 sm:text-sm" target='_blank'>Buy</a>
                  </td>
                  <td className="block px-2 py-2 text-right sm:px-4 sm:py-3 lg:table-cell">
                    
                    <button onClick={() => onSelectCooler(cooler)} className="rounded bg-green-500 px-3 py-1 text-xs font-medium text-white hover:bg-green-600 sm:text-sm">Select</button>
                  </td>
                </tr>
              ))}
            </tbody>
